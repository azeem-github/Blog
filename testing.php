validate spaces and 8characters for 

password through javascript

<?php
session_start();
if($_SESSION['admin_email']){
echo "welcome user " . $_SESSION
...
$_POST["c_password"]) {
    $sql3 = "INSERT INTO adminlogin

(firstname, 

lastname,admin_email,password,c_pa
...
Successfully";
            echo "<script>alert('User Has 

Been Added')</script>";
            echo "<script>window.open

('viewusers.php','_self')</script>";
    }
        }else{
...
for="exampleInputPassword1">Passwo
...
for="exampleInputPassword1">Confir

m Password</label>
                    <input type="password" 

name="c_password" class="form-
